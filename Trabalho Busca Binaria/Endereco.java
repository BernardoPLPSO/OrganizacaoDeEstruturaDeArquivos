...
public class Endereco {
	...
	/*public void procuraCEP(RandomAccessFile f, Long ultimo, long meio, long inicio, int cepAchar) throws IOException{
		if(f.getFilePointer()<f.length()){
			int cepDB = Integer.parseInt(this.getCep());
			if(cepAchar > cepDB){
				inicio = meio;
				meio = 3/2*meio;
				procuraCEP(f,inicio,meio,ultimo,cepAchar);
			}
			else if(cepAchar < cepDB){
				...
				System.out.println(this.getLogradouro());
			}			
		}
	}*/
